...
class QWebSocket(QtCore.QObject):
    ...
    def handshakeInterruptedOnError(self, error: QtNetwork.QSslError) -> None: ...
    def alertReceived(self, level: QtNetwork.QSsl.AlertLevel, type: QtNetwork.QSsl.AlertType, description: str) -> None: ...
    def alertSent(self, level: QtNetwork.QSsl.AlertLevel, type: QtNetwork.QSsl.AlertType, description: str) -> None: ...
    ...
    def pong(self, elapsedTime: int, payload: QtCore.QByteArray) -> None: ...
    def binaryMessageReceived(self, message: QtCore.QByteArray) -> None: ...
    def textMessageReceived(self, message: str) -> None: ...
    def binaryFrameReceived(self, frame: QtCore.QByteArray, isLastFrame: bool) -> None: ...
