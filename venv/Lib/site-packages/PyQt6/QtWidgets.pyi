...
class QWidget(QtCore.QObject, QtGui.QPaintDevice):
    ...
    def setScreen(self, a0: QtGui.QScreen) -> None: ...
    ...
    @staticmethod
    def createWindowContainer(window: QtGui.QWindow, parent: typing.Optional['QWidget'] = ..., flags: QtCore.Qt.WindowType = ...) -> 'QWidget': ...
    ...
    @typing.overload
    def render(self, target: QtGui.QPaintDevice, targetOffset: QtCore.QPoint = ..., sourceRegion: QtGui.QRegion = ..., flags: 'QWidget.RenderFlag' = ...) -> None: ...
    @typing.overload
    def render(self, painter: QtGui.QPainter, targetOffset: QtCore.QPoint = ..., sourceRegion: QtGui.QRegion = ..., flags: 'QWidget.RenderFlag' = ...) -> None: ...
    ...
    @staticmethod
    def find(a0: PyQt6.sip.voidptr) -> 'QWidget': ...
    def overrideWindowFlags(self, type: QtCore.Qt.WindowType) -> None: ...
    def setWindowFlags(self, type: QtCore.Qt.WindowType) -> None: ...
    def actions(self) -> typing.List[QtGui.QAction]: ...
    def removeAction(self, action: QtGui.QAction) -> None: ...
    def insertActions(self, before: QtGui.QAction, actions: typing.Iterable[QtGui.QAction]) -> None: ...
    ...
    @typing.overload
    def setParent(self, parent: 'QWidget', f: QtCore.Qt.WindowType) -> None: ...
    ...
    @typing.overload
    def mapFrom(self, a0: 'QWidget', a1: QtCore.QPointF) -> QtCore.QPointF: ...
    @typing.overload
    def mapTo(self, a0: 'QWidget', a1: QtCore.QPoint) -> QtCore.QPoint: ...
    @typing.overload
    def mapTo(self, a0: 'QWidget', a1: QtCore.QPointF) -> QtCore.QPointF: ...
    @typing.overload
...
class QAbstractScrollArea(QFrame):
    ...
    def scrollBarWidgets(self, alignment: QtCore.Qt.AlignmentFlag) -> typing.List[QWidget]: ...
    def addScrollBarWidget(self, widget: QWidget, alignment: QtCore.Qt.AlignmentFlag) -> None: ...
...
class QLayout(QtCore.QObject, QLayoutItem):
    ...
    def replaceWidget(self, from_: QWidget, to: QWidget, options: QtCore.Qt.FindChildOption = ...) -> QLayoutItem: ...
    def controlTypes(self) -> 'QSizePolicy.ControlType': ...
    def contentsMargins(self) -> QtCore.QMargins: ...
    def contentsRect(self) -> QtCore.QRect: ...
    ...
    @typing.overload
    def setAlignment(self, w: QWidget, alignment: QtCore.Qt.AlignmentFlag) -> bool: ...
    @typing.overload
    def setAlignment(self, l: 'QLayout', alignment: QtCore.Qt.AlignmentFlag) -> bool: ...
    @typing.overload
...
class QBoxLayout(QLayout):
    ...
    def addWidget(self, a0: QWidget, stretch: int = ..., alignment: QtCore.Qt.AlignmentFlag = ...) -> None: ...
...
class QButtonGroup(QtCore.QObject):
    ...
    def idToggled(self, a0: int, a1: bool) -> None: ...
    def idReleased(self, a0: int) -> None: ...
    def idPressed(self, a0: int) -> None: ...
    def idClicked(self, a0: int) -> None: ...
...
class QColorDialog(QDialog):
    ...
    def changeEvent(self, e: QtCore.QEvent) -> None: ...
    def currentColorChanged(self, color: typing.Union[QtGui.QColor, QtCore.Qt.GlobalColor, int]) -> None: ...
    def colorSelected(self, color: typing.Union[QtGui.QColor, QtCore.Qt.GlobalColor, int]) -> None: ...
    @typing.overload
    def open(self) -> None: ...
    @typing.overload
    ...
    def customCount() -> int: ...
    @staticmethod
    def getColor(initial: typing.Union[QtGui.QColor, QtCore.Qt.GlobalColor, int] = ..., parent: typing.Optional[QWidget] = ..., title: str = ..., options: 'QColorDialog.ColorDialogOption' = ...) -> QtGui.QColor: ...
...
class QComboBox(QWidget):
    ...
    def textHighlighted(self, a0: str) -> None: ...
    def textActivated(self, a0: str) -> None: ...
...
class QStyle(QtCore.QObject):
    ...
    class StandardPixmap(enum.Enum):
    ...
    class ComplexControl(enum.Enum):
    ...
    class ControlElement(enum.Enum):
    ...
    class PrimitiveElement(enum.Enum):
...
class QDataWidgetMapper(QtCore.QObject):
    ...
    @typing.overload
    def addMapping(self, widget: QWidget, section: int, propertyName: QtCore.QByteArray) -> None: ...
...
class QDateTimeEdit(QAbstractSpinBox):
    ...
    def timeChanged(self, time: typing.Union[QtCore.QTime, datetime.time]) -> None: ...
...
class QDockWidget(QWidget):
    ...
    @typing.overload
    def __init__(self, title: str, parent: typing.Optional[QWidget] = ..., flags: QtCore.Qt.WindowType = ...) -> None: ...
    @typing.overload
    def __init__(self, parent: typing.Optional[QWidget] = ..., flags: QtCore.Qt.WindowType = ...) -> None: ...
    ...
    def allowedAreasChanged(self, allowedAreas: QtCore.Qt.DockWidgetArea) -> None: ...
...
class QFileDialog(QDialog):
    ...
    @staticmethod
    def saveFileContent(fileContent: QtCore.QByteArray, fileNameHint: str = ...) -> None: ...
    ...
    @staticmethod
    def getSaveFileUrl(parent: typing.Optional[QWidget] = ..., caption: str = ..., directory: QtCore.QUrl = ..., filter: str = ..., initialFilter: str = ..., options: 'QFileDialog.Option' = ..., supportedSchemes: typing.Iterable[str] = ...) -> typing.Tuple[QtCore.QUrl, str]: ...
    @staticmethod
    def getOpenFileUrls(parent: typing.Optional[QWidget] = ..., caption: str = ..., directory: QtCore.QUrl = ..., filter: str = ..., initialFilter: str = ..., options: 'QFileDialog.Option' = ..., supportedSchemes: typing.Iterable[str] = ...) -> typing.Tuple[typing.List[QtCore.QUrl], str]: ...
    @staticmethod
    def getOpenFileUrl(parent: typing.Optional[QWidget] = ..., caption: str = ..., directory: QtCore.QUrl = ..., filter: str = ..., initialFilter: str = ..., options: 'QFileDialog.Option' = ..., supportedSchemes: typing.Iterable[str] = ...) -> typing.Tuple[QtCore.QUrl, str]: ...
    ...
    def done(self, result: int) -> None: ...
    @staticmethod
    def getSaveFileName(parent: typing.Optional[QWidget] = ..., caption: str = ..., directory: str = ..., filter: str = ..., initialFilter: str = ..., options: 'QFileDialog.Option' = ...) -> typing.Tuple[str, str]: ...
    @staticmethod
    def getOpenFileNames(parent: typing.Optional[QWidget] = ..., caption: str = ..., directory: str = ..., filter: str = ..., initialFilter: str = ..., options: 'QFileDialog.Option' = ...) -> typing.Tuple[typing.List[str], str]: ...
    @staticmethod
    def getOpenFileName(parent: typing.Optional[QWidget] = ..., caption: str = ..., directory: str = ..., filter: str = ..., initialFilter: str = ..., options: 'QFileDialog.Option' = ...) -> typing.Tuple[str, str]: ...
    @staticmethod
    def getExistingDirectoryUrl(parent: typing.Optional[QWidget] = ..., caption: str = ..., directory: QtCore.QUrl = ..., options: 'QFileDialog.Option' = ..., supportedSchemes: typing.Iterable[str] = ...) -> QtCore.QUrl: ...
    @staticmethod
    def getExistingDirectory(parent: typing.Optional[QWidget] = ..., caption: str = ..., directory: str = ..., options: 'QFileDialog.Option' = ...) -> str: ...
...
class QFontDialog(QDialog):
    ...
    @typing.overload
    @staticmethod
    def getFont(initial: QtGui.QFont, parent: typing.Optional[QWidget] = ..., caption: str = ..., options: 'QFontDialog.FontDialogOption' = ...) -> typing.Tuple[QtGui.QFont, bool]: ...
    @typing.overload
    @staticmethod
...
class QGestureRecognizer(PyQt6.sip.wrapper):
    ...
    def recognize(self, state: QGesture, watched: QtCore.QObject, event: QtCore.QEvent) -> 'QGestureRecognizer.ResultFlag': ...
...
class QGraphicsAnchorLayout(QGraphicsLayout):
    ...
    def addAnchors(self, firstItem: QGraphicsLayoutItem, secondItem: QGraphicsLayoutItem, orientations: QtCore.Qt.Orientation = ...) -> None: ...
...
class QGraphicsColorizeEffect(QGraphicsEffect):
    ...
    def colorChanged(self, color: typing.Union[QtGui.QColor, QtCore.Qt.GlobalColor, int]) -> None: ...
...
class QGraphicsBlurEffect(QGraphicsEffect):
    ...
    def draw(self, painter: QtGui.QPainter) -> None: ...
    def blurHintsChanged(self, hints: 'QGraphicsBlurEffect.BlurHint') -> None: ...
...
class QGraphicsDropShadowEffect(QGraphicsEffect):
    ...
    def colorChanged(self, color: typing.Union[QtGui.QColor, QtCore.Qt.GlobalColor, int]) -> None: ...
    def blurRadiusChanged(self, blurRadius: float) -> None: ...
    def offsetChanged(self, offset: QtCore.QPointF) -> None: ...
...
class QGraphicsOpacityEffect(QGraphicsEffect):
    ...
    def draw(self, painter: QtGui.QPainter) -> None: ...
    def opacityMaskChanged(self, mask: typing.Union[QtGui.QBrush, QtGui.QColor, QtCore.Qt.GlobalColor, int, QtGui.QGradient]) -> None: ...
    def opacityChanged(self, opacity: float) -> None: ...
    def setOpacityMask(self, mask: typing.Union[QtGui.QBrush, QtGui.QColor, QtCore.Qt.GlobalColor, int, QtGui.QGradient]) -> None: ...
...
class QGraphicsGridLayout(QGraphicsLayout):
    ...
    def rowCount(self) -> int: ...
    def alignment(self, item: QGraphicsLayoutItem) -> QtCore.Qt.AlignmentFlag: ...
    def setAlignment(self, item: QGraphicsLayoutItem, alignment: QtCore.Qt.AlignmentFlag) -> None: ...
    ...
    def setHorizontalSpacing(self, spacing: float) -> None: ...
    @typing.overload
    def addItem(self, item: QGraphicsLayoutItem, row: int, column: int, rowSpan: int, columnSpan: int, alignment: QtCore.Qt.AlignmentFlag = ...) -> None: ...
    @typing.overload
    def addItem(self, item: QGraphicsLayoutItem, row: int, column: int, alignment: QtCore.Qt.AlignmentFlag = ...) -> None: ...
...
class QAbstractGraphicsShapeItem(QGraphicsItem):
    ...
    def opaqueArea(self) -> QtGui.QPainterPath: ...
    def isObscuredBy(self, item: QGraphicsItem) -> bool: ...
    def setBrush(self, brush: typing.Union[QtGui.QBrush, QtGui.QColor, QtCore.Qt.GlobalColor, int, QtGui.QGradient]) -> None: ...
    def brush(self) -> QtGui.QBrush: ...
    def setPen(self, pen: typing.Union[QtGui.QPen, QtGui.QColor, QtCore.Qt.GlobalColor, int, QtGui.QGradient]) -> None: ...
...
class QGraphicsTextItem(QGraphicsObject):
    ...
    def setDefaultTextColor(self, c: typing.Union[QtGui.QColor, QtCore.Qt.GlobalColor, int, QtGui.QGradient]) -> None: ...
    def setFont(self, font: QtGui.QFont) -> None: ...
    def font(self) -> QtGui.QFont: ...
...
class QGraphicsScene(QtCore.QObject):
    ...
    def setStyle(self, style: QStyle) -> None: ...
    def style(self) -> QStyle: ...
    def addWidget(self, widget: QWidget, flags: QtCore.Qt.WindowType = ...) -> QGraphicsProxyWidget: ...
    ...
    def inputMethodQuery(self, query: QtCore.Qt.InputMethodQuery) -> typing.Any: ...
    def setForegroundBrush(self, brush: typing.Union[QtGui.QBrush, QtGui.QColor, QtCore.Qt.GlobalColor, int, QtGui.QGradient]) -> None: ...
    def foregroundBrush(self) -> QtGui.QBrush: ...
    def setBackgroundBrush(self, brush: typing.Union[QtGui.QBrush, QtGui.QColor, QtCore.Qt.GlobalColor, int, QtGui.QGradient]) -> None: ...
    ...
    @typing.overload
    def addRect(self, rect: QtCore.QRectF, pen: typing.Union[QtGui.QPen, QtGui.QColor, QtCore.Qt.GlobalColor, int, QtGui.QGradient] = ..., brush: typing.Union[QtGui.QBrush, QtGui.QColor, QtCore.Qt.GlobalColor, int, QtGui.QGradient] = ...) -> QGraphicsRectItem: ...
    @typing.overload
    def addRect(self, x: float, y: float, w: float, h: float, pen: typing.Union[QtGui.QPen, QtGui.QColor, QtCore.Qt.GlobalColor, int, QtGui.QGradient] = ..., brush: typing.Union[QtGui.QBrush, QtGui.QColor, QtCore.Qt.GlobalColor, int, QtGui.QGradient] = ...) -> QGraphicsRectItem: ...
    def addPolygon(self, polygon: QtGui.QPolygonF, pen: typing.Union[QtGui.QPen, QtGui.QColor, QtCore.Qt.GlobalColor, int, QtGui.QGradient] = ..., brush: typing.Union[QtGui.QBrush, QtGui.QColor, QtCore.Qt.GlobalColor, int, QtGui.QGradient] = ...) -> QGraphicsPolygonItem: ...
    def addPixmap(self, pixmap: QtGui.QPixmap) -> QGraphicsPixmapItem: ...
    def addPath(self, path: QtGui.QPainterPath, pen: typing.Union[QtGui.QPen, QtGui.QColor, QtCore.Qt.GlobalColor, int, QtGui.QGradient] = ..., brush: typing.Union[QtGui.QBrush, QtGui.QColor, QtCore.Qt.GlobalColor, int, QtGui.QGradient] = ...) -> QGraphicsPathItem: ...
    @typing.overload
    def addLine(self, line: QtCore.QLineF, pen: typing.Union[QtGui.QPen, QtGui.QColor, QtCore.Qt.GlobalColor, int, QtGui.QGradient] = ...) -> QGraphicsLineItem: ...
    @typing.overload
    def addLine(self, x1: float, y1: float, x2: float, y2: float, pen: typing.Union[QtGui.QPen, QtGui.QColor, QtCore.Qt.GlobalColor, int, QtGui.QGradient] = ...) -> QGraphicsLineItem: ...
    @typing.overload
    def addEllipse(self, rect: QtCore.QRectF, pen: typing.Union[QtGui.QPen, QtGui.QColor, QtCore.Qt.GlobalColor, int, QtGui.QGradient] = ..., brush: typing.Union[QtGui.QBrush, QtGui.QColor, QtCore.Qt.GlobalColor, int, QtGui.QGradient] = ...) -> QGraphicsEllipseItem: ...
    @typing.overload
    def addEllipse(self, x: float, y: float, w: float, h: float, pen: typing.Union[QtGui.QPen, QtGui.QColor, QtCore.Qt.GlobalColor, int, QtGui.QGradient] = ..., brush: typing.Union[QtGui.QBrush, QtGui.QColor, QtCore.Qt.GlobalColor, int, QtGui.QGradient] = ...) -> QGraphicsEllipseItem: ...
    ...
    @typing.overload
    def items(self, pos: QtCore.QPointF, mode: QtCore.Qt.ItemSelectionMode = ..., order: QtCore.Qt.SortOrder = ..., deviceTransform: QtGui.QTransform = ...) -> typing.List[QGraphicsItem]: ...
    @typing.overload
...
class QGraphicsView(QAbstractScrollArea):
    ...
    def rubberBandChanged(self, viewportRect: QtCore.QRect, fromScenePoint: QtCore.QPointF, toScenePoint: QtCore.QPointF) -> None: ...
...
class QGridLayout(QLayout):
    ...
    @typing.overload
    def addItem(self, item: QLayoutItem, row: int, column: int, rowSpan: int = ..., columnSpan: int = ..., alignment: QtCore.Qt.AlignmentFlag = ...) -> None: ...
    @typing.overload
    def addItem(self, a0: QLayoutItem) -> None: ...
    def setGeometry(self, a0: QtCore.QRect) -> None: ...
    def count(self) -> int: ...
    ...
    @typing.overload
    def addLayout(self, a0: QLayout, row: int, column: int, alignment: QtCore.Qt.AlignmentFlag = ...) -> None: ...
    @typing.overload
    def addLayout(self, a0: QLayout, row: int, column: int, rowSpan: int, columnSpan: int, alignment: QtCore.Qt.AlignmentFlag = ...) -> None: ...
    @typing.overload
    def addWidget(self, w: QWidget) -> None: ...
    @typing.overload
    def addWidget(self, a0: QWidget, row: int, column: int, alignment: QtCore.Qt.AlignmentFlag = ...) -> None: ...
    @typing.overload
    def addWidget(self, a0: QWidget, row: int, column: int, rowSpan: int, columnSpan: int, alignment: QtCore.Qt.AlignmentFlag = ...) -> None: ...
    def invalidate(self) -> None: ...
    def expandingDirections(self) -> QtCore.Qt.Orientation: ...
    def minimumHeightForWidth(self, a0: int) -> int: ...
    def heightForWidth(self, a0: int) -> int: ...
...
class QInputDialog(QDialog):
    ...
    @staticmethod
    def getMultiLineText(parent: QWidget, title: str, label: str, text: str = ..., flags: QtCore.Qt.WindowType = ..., inputMethodHints: QtCore.Qt.InputMethodHint = ...) -> typing.Tuple[str, bool]: ...
    @staticmethod
    def getItem(parent: QWidget, title: str, label: str, items: typing.Iterable[str], current: int = ..., editable: bool = ..., flags: QtCore.Qt.WindowType = ..., inputMethodHints: QtCore.Qt.InputMethodHint = ...) -> typing.Tuple[str, bool]: ...
    @staticmethod
    def getDouble(parent: QWidget, title: str, label: str, value: float = ..., min: float = ..., max: float = ..., decimals: int = ..., flags: QtCore.Qt.WindowType = ..., step: float = ...) -> typing.Tuple[float, bool]: ...
    @staticmethod
    def getInt(parent: QWidget, title: str, label: str, value: int = ..., min: int = ..., max: int = ..., step: int = ..., flags: QtCore.Qt.WindowType = ...) -> typing.Tuple[int, bool]: ...
    @staticmethod
    def getText(parent: QWidget, title: str, label: str, echo: 'QLineEdit.EchoMode' = ..., text: str = ..., flags: QtCore.Qt.WindowType = ..., inputMethodHints: QtCore.Qt.InputMethodHint = ...) -> typing.Tuple[str, bool]: ...
...
class QLabel(QFrame):
    ...
    def __init__(self, parent: typing.Optional[QWidget] = ..., flags: QtCore.Qt.WindowType = ...) -> None: ...
    @typing.overload
    def __init__(self, text: str, parent: typing.Optional[QWidget] = ..., flags: QtCore.Qt.WindowType = ...) -> None: ...
...
class QLineEdit(QWidget):
    ...
    @typing.overload
    def addAction(self, icon: QtGui.QIcon, position: 'QLineEdit.ActionPosition') -> QtGui.QAction: ...
...
class QListWidgetItem(PyQt6.sip.wrapper):
    ...
    def setForeground(self, brush: typing.Union[QtGui.QBrush, QtGui.QColor, QtCore.Qt.GlobalColor, int, QtGui.QGradient]) -> None: ...
    def foreground(self) -> QtGui.QBrush: ...
    def setBackground(self, brush: typing.Union[QtGui.QBrush, QtGui.QColor, QtCore.Qt.GlobalColor, int, QtGui.QGradient]) -> None: ...
...
class QListWidget(QListView):
    ...
    def clear(self) -> None: ...
    def findItems(self, text: str, flags: QtCore.Qt.MatchFlag) -> typing.List[QListWidgetItem]: ...
    ...
    @typing.overload
    def setCurrentItem(self, item: QListWidgetItem, command: QtCore.QItemSelectionModel.SelectionFlag) -> None: ...
...
class QMdiArea(QAbstractScrollArea):
    ...
    def setBackground(self, background: typing.Union[QtGui.QBrush, QtGui.QColor, QtCore.Qt.GlobalColor, int, QtGui.QGradient]) -> None: ...
    def background(self) -> QtGui.QBrush: ...
    ...
    def addSubWindow(self, widget: QWidget, flags: QtCore.Qt.WindowType = ...) -> 'QMdiSubWindow': ...
...
class QMdiSubWindow(QWidget):
    ...
    def windowStateChanged(self, oldState: QtCore.Qt.WindowState, newState: QtCore.Qt.WindowState) -> None: ...
...
class QMenu(QWidget):
    ...
    @typing.overload
    def insertSection(self, before: QtGui.QAction, icon: QtGui.QIcon, text: str) -> QtGui.QAction: ...
    @typing.overload
    def addSection(self, text: str) -> QtGui.QAction: ...
    @typing.overload
    def addSection(self, icon: QtGui.QIcon, text: str) -> QtGui.QAction: ...
    ...
    def columnCount(self) -> int: ...
    def triggered(self, action: QtGui.QAction) -> None: ...
    def hovered(self, action: QtGui.QAction) -> None: ...
    ...
    @typing.overload
    @staticmethod
    def exec(actions: typing.Iterable[QtGui.QAction], pos: QtCore.QPoint, at: typing.Optional[QtGui.QAction] = ..., parent: typing.Optional[QWidget] = ...) -> QtGui.QAction: ...
    ...
    def setDefaultAction(self, a0: QtGui.QAction) -> None: ...
    ...
    @typing.overload
    def addAction(self, text: str, slot: PYQT_SLOT, shortcut: typing.Union[QtGui.QKeySequence, QtGui.QKeySequence.StandardKey, str, int] = ...) -> QtGui.QAction: ...
    @typing.overload
    def addAction(self, icon: QtGui.QIcon, text: str) -> QtGui.QAction: ...
    @typing.overload
    def addAction(self, icon: QtGui.QIcon, text: str, slot: PYQT_SLOT, shortcut: typing.Union[QtGui.QKeySequence, QtGui.QKeySequence.StandardKey, str, int] = ...) -> QtGui.QAction: ...
...
class QMessageBox(QDialog):
    ...
    @staticmethod
    def critical(parent: QWidget, title: str, text: str, buttons: 'QMessageBox.StandardButton' = ..., defaultButton: 'QMessageBox.StandardButton' = ...) -> 'QMessageBox.StandardButton': ...
    @staticmethod
    def warning(parent: QWidget, title: str, text: str, buttons: 'QMessageBox.StandardButton' = ..., defaultButton: 'QMessageBox.StandardButton' = ...) -> 'QMessageBox.StandardButton': ...
    @staticmethod
    def question(parent: QWidget, title: str, text: str, buttons: 'QMessageBox.StandardButton' = ..., defaultButton: 'QMessageBox.StandardButton' = ...) -> 'QMessageBox.StandardButton': ...
    @staticmethod
    def information(parent: QWidget, title: str, text: str, buttons: 'QMessageBox.StandardButton' = ..., defaultButton: 'QMessageBox.StandardButton' = ...) -> 'QMessageBox.StandardButton': ...
    def setTextFormat(self, a0: QtCore.Qt.TextFormat) -> None: ...
    def textFormat(self) -> QtCore.Qt.TextFormat: ...
...
class QProgressDialog(QDialog):
    ...
    def __init__(self, parent: typing.Optional[QWidget] = ..., flags: QtCore.Qt.WindowType = ...) -> None: ...
    @typing.overload
    def __init__(self, labelText: str, cancelButtonText: str, minimum: int, maximum: int, parent: typing.Optional[QWidget] = ..., flags: QtCore.Qt.WindowType = ...) -> None: ...
...
class QSplashScreen(QWidget):
    ...
    @typing.overload
    def __init__(self, screen: QtGui.QScreen, pixmap: QtGui.QPixmap = ..., flags: QtCore.Qt.WindowType = ...) -> None: ...
    ...
    def showMessage(self, message: str, alignment: int = ..., color: typing.Union[QtGui.QColor, QtCore.Qt.GlobalColor, int, QtGui.QGradient] = ...) -> None: ...
...
class QTabBar(QWidget):
    ...
    def setTabTextColor(self, index: int, color: typing.Union[QtGui.QColor, QtCore.Qt.GlobalColor, int, QtGui.QGradient]) -> None: ...
...
class QTableWidget(QTableView):
    ...
    def findItems(self, text: str, flags: QtCore.Qt.MatchFlag) -> typing.List[QTableWidgetItem]: ...
    ...
    @typing.overload
    def setCurrentItem(self, item: QTableWidgetItem, command: QtCore.QItemSelectionModel.SelectionFlag) -> None: ...
...
class QTextEdit(QAbstractScrollArea):
    ...
    def placeholderText(self) -> str: ...
    def setPlaceholderText(self, placeholderText: str) -> None: ...
    def setTextBackgroundColor(self, c: typing.Union[QtGui.QColor, QtCore.Qt.GlobalColor, int, QtGui.QGradient]) -> None: ...
    ...
    def setAlignment(self, a: QtCore.Qt.AlignmentFlag) -> None: ...
    def setCurrentFont(self, f: QtGui.QFont) -> None: ...
    def setTextColor(self, c: typing.Union[QtGui.QColor, QtCore.Qt.GlobalColor, int, QtGui.QGradient]) -> None: ...
    def setText(self, text: str) -> None: ...
...
class QToolBar(QWidget):
    ...
    def allowedAreasChanged(self, allowedAreas: QtCore.Qt.ToolBarArea) -> None: ...
    def movableChanged(self, movable: bool) -> None: ...
    def actionTriggered(self, action: QtGui.QAction) -> None: ...
    def setToolButtonStyle(self, toolButtonStyle: QtCore.Qt.ToolButtonStyle) -> None: ...
    def setIconSize(self, iconSize: QtCore.QSize) -> None: ...
...
class QToolButton(QAbstractButton):
    ...
    def triggered(self, a0: QtGui.QAction) -> None: ...
    def setDefaultAction(self, a0: QtGui.QAction) -> None: ...
...
class QToolTip(PyQt6.sip.simplewrapper):
    ...
    def palette() -> QtGui.QPalette: ...
    @staticmethod
    def showText(pos: QtCore.QPoint, text: str, widget: typing.Optional[QWidget] = ..., rect: QtCore.QRect = ..., msecShowTime: int = ...) -> None: ...
...
class QTreeWidgetItem(PyQt6.sip.wrapper):
    ...
    @typing.overload
    def __init__(self, parent: 'QTreeWidget', after: 'QTreeWidgetItem', type: int = ...) -> None: ...
    @typing.overload
    ...
    def setForeground(self, column: int, brush: typing.Union[QtGui.QBrush, QtGui.QColor, QtCore.Qt.GlobalColor, int, QtGui.QGradient]) -> None: ...
    def foreground(self, column: int) -> QtGui.QBrush: ...
    def setBackground(self, column: int, brush: typing.Union[QtGui.QBrush, QtGui.QColor, QtCore.Qt.GlobalColor, int, QtGui.QGradient]) -> None: ...
...
class QTreeWidget(QTreeView):
    ...
    def findItems(self, text: str, flags: QtCore.Qt.MatchFlag, column: int = ...) -> typing.List[QTreeWidgetItem]: ...
    ...
    @typing.overload
    def setCurrentItem(self, item: QTreeWidgetItem, column: int, command: QtCore.QItemSelectionModel.SelectionFlag) -> None: ...
    def currentColumn(self) -> int: ...
...
class QUndoView(QListView):
    ...
    def __init__(self, parent: typing.Optional[QWidget] = ...) -> None: ...
    @typing.overload
    def __init__(self, stack: QtGui.QUndoStack, parent: typing.Optional[QWidget] = ...) -> None: ...
    @typing.overload
    def __init__(self, group: QtGui.QUndoGroup, parent: typing.Optional[QWidget] = ...) -> None: ...
...
class QWhatsThis(PyQt6.sip.simplewrapper):
    ...
    @staticmethod
    def createAction(parent: typing.Optional[QtCore.QObject] = ...) -> QtGui.QAction: ...
    @staticmethod
    def hideText() -> None: ...
    @staticmethod
...
@typing.overload
def qDrawPlainRect(p: QtGui.QPainter, x: int, y: int, w: int, h: int, a5: typing.Union[QtGui.QColor, QtCore.Qt.GlobalColor, int, QtGui.QGradient], lineWidth: int = ..., fill: typing.Optional[typing.Union[QtGui.QBrush, QtGui.QColor, QtCore.Qt.GlobalColor, int, QtGui.QGradient]] = ...) -> None: ...
@typing.overload
def qDrawPlainRect(p: QtGui.QPainter, r: QtCore.QRect, a2: typing.Union[QtGui.QColor, QtCore.Qt.GlobalColor, int, QtGui.QGradient], lineWidth: int = ..., fill: typing.Optional[typing.Union[QtGui.QBrush, QtGui.QColor, QtCore.Qt.GlobalColor, int, QtGui.QGradient]] = ...) -> None: ...
@typing.overload
def qDrawWinPanel(p: QtGui.QPainter, x: int, y: int, w: int, h: int, pal: QtGui.QPalette, sunken: bool = ..., fill: typing.Optional[typing.Union[QtGui.QBrush, QtGui.QColor, QtCore.Qt.GlobalColor, int, QtGui.QGradient]] = ...) -> None: ...
@typing.overload
def qDrawWinPanel(p: QtGui.QPainter, r: QtCore.QRect, pal: QtGui.QPalette, sunken: bool = ..., fill: typing.Optional[typing.Union[QtGui.QBrush, QtGui.QColor, QtCore.Qt.GlobalColor, int, QtGui.QGradient]] = ...) -> None: ...
@typing.overload
def qDrawWinButton(p: QtGui.QPainter, x: int, y: int, w: int, h: int, pal: QtGui.QPalette, sunken: bool = ..., fill: typing.Optional[typing.Union[QtGui.QBrush, QtGui.QColor, QtCore.Qt.GlobalColor, int, QtGui.QGradient]] = ...) -> None: ...
@typing.overload
def qDrawWinButton(p: QtGui.QPainter, r: QtCore.QRect, pal: QtGui.QPalette, sunken: bool = ..., fill: typing.Optional[typing.Union[QtGui.QBrush, QtGui.QColor, QtCore.Qt.GlobalColor, int, QtGui.QGradient]] = ...) -> None: ...
@typing.overload
def qDrawShadePanel(p: QtGui.QPainter, x: int, y: int, w: int, h: int, pal: QtGui.QPalette, sunken: bool = ..., lineWidth: int = ..., fill: typing.Optional[typing.Union[QtGui.QBrush, QtGui.QColor, QtCore.Qt.GlobalColor, int, QtGui.QGradient]] = ...) -> None: ...
@typing.overload
def qDrawShadePanel(p: QtGui.QPainter, r: QtCore.QRect, pal: QtGui.QPalette, sunken: bool = ..., lineWidth: int = ..., fill: typing.Optional[typing.Union[QtGui.QBrush, QtGui.QColor, QtCore.Qt.GlobalColor, int, QtGui.QGradient]] = ...) -> None: ...
@typing.overload
def qDrawShadeRect(p: QtGui.QPainter, x: int, y: int, w: int, h: int, pal: QtGui.QPalette, sunken: bool = ..., lineWidth: int = ..., midLineWidth: int = ..., fill: typing.Optional[typing.Union[QtGui.QBrush, QtGui.QColor, QtCore.Qt.GlobalColor, int, QtGui.QGradient]] = ...) -> None: ...
@typing.overload
def qDrawShadeRect(p: QtGui.QPainter, r: QtCore.QRect, pal: QtGui.QPalette, sunken: bool = ..., lineWidth: int = ..., midLineWidth: int = ..., fill: typing.Optional[typing.Union[QtGui.QBrush, QtGui.QColor, QtCore.Qt.GlobalColor, int, QtGui.QGradient]] = ...) -> None: ...
@typing.overload
