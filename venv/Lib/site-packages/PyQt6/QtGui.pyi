...
class QPixmap(QPaintDevice):
    ...
    @typing.overload
    def loadFromData(self, buf: bytes, format: typing.Optional[str] = ..., flags: QtCore.Qt.ImageConversionFlag = ...) -> bool: ...
    @typing.overload
...
class QPaintEngine(PyQt6.sip.simplewrapper):
    ...
    @typing.overload
    def drawPolygon(self, points: QtCore.QPointF, mode: 'QPaintEngine.PolygonDrawMode') -> None: ...
    @typing.overload
    def drawPolygon(self, points: QtCore.QPoint, mode: 'QPaintEngine.PolygonDrawMode') -> None: ...
    @typing.overload
    def drawPoints(self, points: QtCore.QPointF) -> None: ...
    @typing.overload
...
class QPainter(PyQt6.sip.simplewrapper):
    ...
    def drawPixmapFragments(self, fragments: typing.List['QPainter.PixmapFragment'], pixmap: QPixmap, hints: 'QPainter.PixmapFragmentHint' = ...) -> None: ...
