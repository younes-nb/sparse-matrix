...
class QObject(PyQt6.sip.wrapper):
    ...
    @staticmethod
    def tr(sourceText: str, disambiguation: typing.Optional[str] = ..., n: int = ...) -> str: ...
...
class QAbstractNativeEventFilter(PyQt6.sip.simplewrapper):
    ...
    def nativeEventFilter(self, eventType: 'QByteArray', message: PyQt6.sip.voidptr) -> typing.Tuple[bool, PyQt6.sip.voidptr]: ...
...
class QBuffer(QIODevice):
    ...
    @typing.overload
    def setData(self, data: 'QByteArray') -> None: ...
    @typing.overload
...
class QByteArray(PyQt6.sip.simplewrapper):
    ...
    @typing.overload
    def __init__(self, a: 'QByteArray') -> None: ...
    ...
    @staticmethod
    def fromBase64Encoding(base64: 'QByteArray', options: 'QByteArray.Base64Option' = ...) -> 'QByteArray.FromBase64Result': ...
    ...
    @staticmethod
    def fromPercentEncoding(input: 'QByteArray', percent: str = ...) -> 'QByteArray': ...
    def toPercentEncoding(self, exclude: 'QByteArray' = ..., include: 'QByteArray' = ..., percent: str = ...) -> 'QByteArray': ...
    ...
    def length(self) -> int: ...
    @staticmethod
    def fromHex(hexEncoded: 'QByteArray') -> 'QByteArray': ...
    @staticmethod
    def fromBase64(base64: 'QByteArray', options: 'QByteArray.Base64Option' = ...) -> 'QByteArray': ...
    @typing.overload
    @staticmethod
    ...
    def split(self, sep: bytes) -> typing.List['QByteArray']: ...
    @typing.overload
...
class QByteArrayMatcher(PyQt6.sip.simplewrapper):
    ...
    @typing.overload
    def __init__(self, pattern: QByteArray) -> None: ...
    @typing.overload
    ...
    @typing.overload
    def indexIn(self, ba: QByteArray, from_: int = ...) -> int: ...
    def setPattern(self, pattern: QByteArray) -> None: ...
...
class QCborStreamWriter(PyQt6.sip.simplewrapper):
    ...
    @typing.overload
    def append(self, ba: QByteArray) -> None: ...
    @typing.overload
...
class QDynamicPropertyChangeEvent(QEvent):
    ...
    def __init__(self, name: QByteArray) -> None: ...
...
class QDataStream(QIODeviceBase):
    ...
    @typing.overload
    def __init__(self, a0: QByteArray, flags: QIODeviceBase.OpenModeFlag) -> None: ...
    @typing.overload
...
class QDir(PyQt6.sip.simplewrapper):
    ...
    @typing.overload
    def __init__(self, path: str, nameFilter: str, sort: 'QDir.SortFlag' = ..., filters: 'QDir.Filter' = ...) -> None: ...
    @typing.overload
    ...
    @typing.overload
    def entryInfoList(self, filters: 'QDir.Filter' = ..., sort: 'QDir.SortFlag' = ...) -> typing.List['QFileInfo']: ...
    @typing.overload
    def entryInfoList(self, nameFilters: typing.Iterable[str], filters: 'QDir.Filter' = ..., sort: 'QDir.SortFlag' = ...) -> typing.List['QFileInfo']: ...
    @typing.overload
    def entryList(self, filters: 'QDir.Filter' = ..., sort: 'QDir.SortFlag' = ...) -> typing.List[str]: ...
    @typing.overload
    def entryList(self, nameFilters: typing.Iterable[str], filters: 'QDir.Filter' = ..., sort: 'QDir.SortFlag' = ...) -> typing.List[str]: ...
    @staticmethod
...
class QFile(QFileDevice):
    ...
    @typing.overload
    @staticmethod
    def setPermissions(filename: str, permissionSpec: QFileDevice.Permission) -> bool: ...
    @typing.overload
    def permissions(self) -> QFileDevice.Permission: ...
    @typing.overload
    @staticmethod
    def permissions(filename: str) -> QFileDevice.Permission: ...
    @typing.overload
    def resize(self, sz: int) -> bool: ...
    @typing.overload
    @staticmethod
    ...
    @typing.overload
    @staticmethod
    def decodeName(localFileName: QByteArray) -> str: ...
    @typing.overload
    @staticmethod
...
class QJsonDocument(PyQt6.sip.simplewrapper):
    ...
    @staticmethod
    def fromJson(json: QByteArray, error: typing.Optional[QJsonParseError] = ...) -> 'QJsonDocument': ...
...
class QLibrary(QObject):
    ...
    @typing.overload
    @staticmethod
    def resolve(fileName: str, symbol: str) -> PyQt6.sip.voidptr: ...
    @typing.overload
    @staticmethod
    def resolve(fileName: str, verNum: int, symbol: str) -> PyQt6.sip.voidptr: ...
    @typing.overload
    @staticmethod
    def resolve(fileName: str, version: str, symbol: str) -> PyQt6.sip.voidptr: ...
...
class QLineF(PyQt6.sip.simplewrapper):
    ...
    def x1(self) -> float: ...
    def __repr__(self) -> str: ...
    def intersects(self, l: 'QLineF') -> typing.Tuple['QLineF.IntersectionType', 'QPointF']: ...
...
class QLocale(PyQt6.sip.simplewrapper):
    ...
    @staticmethod
    def matchingLocales(language: 'QLocale.Language', script: 'QLocale.Script', territory: 'QLocale.Country') -> typing.List['QLocale']: ...
    @staticmethod
    def scriptToString(script: 'QLocale.Script') -> str: ...
    def uiLanguages(self) -> typing.List[str]: ...
    @typing.overload
    def toCurrencyString(self, a0: float, symbol: str = ..., precision: int = ...) -> str: ...
    @typing.overload
...
class QMessageAuthenticationCode(PyQt6.sip.simplewrapper):
    ...
    def __init__(self, method: QCryptographicHash.Algorithm, key: QByteArray = ...) -> None: ...

    @staticmethod
    def hash(message: QByteArray, key: QByteArray, method: QCryptographicHash.Algorithm) -> QByteArray: ...
    def result(self) -> QByteArray: ...
    @typing.overload
    def addData(self, a0: PyQt6.sip.Buffer) -> None: ...
    @typing.overload
    def addData(self, device: QIODevice) -> bool: ...
    def setKey(self, key: QByteArray) -> None: ...
    def reset(self) -> None: ...
...
class QMimeData(QObject):
    ...
    def retrieveData(self, mimetype: str, preferredType: QMetaType) -> typing.Any: ...
    def removeFormat(self, mimetype: str) -> None: ...
    def clear(self) -> None: ...
    def formats(self) -> typing.List[str]: ...
    def hasFormat(self, mimetype: str) -> bool: ...
    def setData(self, mimetype: str, data: QByteArray) -> None: ...
...
class QMimeDatabase(PyQt6.sip.simplewrapper):
    ...
    @typing.overload
    def mimeTypeForFileNameAndData(self, fileName: str, data: QByteArray) -> 'QMimeType': ...
    def mimeTypeForUrl(self, url: 'QUrl') -> 'QMimeType': ...
    @typing.overload
    def mimeTypeForData(self, data: QByteArray) -> 'QMimeType': ...
    @typing.overload
...
class QOperatingSystemVersion(PyQt6.sip.simplewrapper):
...
class QPropertyAnimation(QVariantAnimation):
    ...
    def __init__(self, parent: typing.Optional[QObject] = ...) -> None: ...
    @typing.overload
    def __init__(self, target: QObject, propertyName: QByteArray, parent: typing.Optional[QObject] = ...) -> None: ...

    def updateState(self, newState: QAbstractAnimation.State, oldState: QAbstractAnimation.State) -> None: ...
    def updateCurrentValue(self, value: typing.Any) -> None: ...
    def event(self, event: QEvent) -> bool: ...
    def setPropertyName(self, propertyName: QByteArray) -> None: ...
    def propertyName(self) -> QByteArray: ...
...
class QRegularExpression(PyQt6.sip.simplewrapper):
    ...
    def globalMatch(self, subjectView: str, offset: int = ..., matchType: 'QRegularExpression.MatchType' = ..., matchOptions: 'QRegularExpression.MatchOption' = ...) -> 'QRegularExpressionMatchIterator': ...
    def match(self, subjectView: str, offset: int = ..., matchType: 'QRegularExpression.MatchType' = ..., matchOptions: 'QRegularExpression.MatchOption' = ...) -> 'QRegularExpressionMatch': ...
...
class QSortFilterProxyModel(QAbstractProxyModel):
    ...
    def autoAcceptChildRowsChanged(self, autoAcceptChildRows: bool) -> None: ...
...
class QStandardPaths(PyQt6.sip.simplewrapper):
    ...
    @staticmethod
    def locateAll(type: 'QStandardPaths.StandardLocation', fileName: str, options: 'QStandardPaths.LocateOption' = ...) -> typing.List[str]: ...
    @staticmethod
...
class QStringConverterBase(PyQt6.sip.simplewrapper):
    ...
    def __init__(self) -> None: ...
    @typing.overload
    def __init__(self, a0: 'QStringConverterBase') -> None: ...
...
class QTextStream(QIODeviceBase):
    ...
    def __init__(self, device: QIODevice) -> None: ...
    @typing.overload
    def __init__(self, array: QByteArray, mode: QIODeviceBase.OpenModeFlag = ...) -> None: ...
...
class QTimeZone(PyQt6.sip.simplewrapper):
    ...
    @typing.overload
    def __init__(self, ianaId: QByteArray) -> None: ...
    @typing.overload
    ...
    @typing.overload
    @staticmethod
    def windowsIdToIanaIds(windowsId: QByteArray) -> typing.List[QByteArray]: ...
    @typing.overload
    @staticmethod
    def windowsIdToIanaIds(windowsId: QByteArray, territory: QLocale.Country) -> typing.List[QByteArray]: ...
    @typing.overload
    @staticmethod
    def windowsIdToDefaultIanaId(windowsId: QByteArray) -> QByteArray: ...
    @typing.overload
    @staticmethod
    def windowsIdToDefaultIanaId(windowsId: QByteArray, territory: QLocale.Country) -> QByteArray: ...
    @staticmethod
    def ianaIdToWindowsId(ianaId: QByteArray) -> QByteArray: ...
    @typing.overload
    @staticmethod
    def availableTimeZoneIds(territory: QLocale.Country) -> typing.List[QByteArray]: ...
    @typing.overload
    @staticmethod
    ...
    @staticmethod
    def isTimeZoneIdAvailable(ianaId: QByteArray) -> bool: ...
    @staticmethod
...
class QUrl(PyQt6.sip.simplewrapper):
    ...
    @staticmethod
    def toStringList(uris: typing.Iterable['QUrl'], options: 'QUrl.UrlFormattingOption' = ...) -> typing.List[str]: ...
    ...
    @staticmethod
    def fromAce(a0: QByteArray) -> str: ...
    def errorString(self) -> str: ...
    def hasFragment(self) -> bool: ...
    def hasQuery(self) -> bool: ...
    @staticmethod
    def toPercentEncoding(input: str, exclude: QByteArray = ..., include: QByteArray = ...) -> QByteArray: ...
    @staticmethod
    def fromPercentEncoding(a0: QByteArray) -> str: ...
    def isDetached(self) -> bool: ...
    def detach(self) -> None: ...
    @staticmethod
    def fromEncoded(u: QByteArray, mode: 'QUrl.ParsingMode' = ...) -> 'QUrl': ...
...
class QUrlQuery(PyQt6.sip.simplewrapper):
    ...
    def allQueryItemValues(self, key: str, options: QUrl.ComponentFormattingOption = ...) -> typing.List[str]: ...
    def queryItemValue(self, key: str, options: QUrl.ComponentFormattingOption = ...) -> str: ...
    def removeQueryItem(self, key: str) -> None: ...
    def addQueryItem(self, key: str, value: str) -> None: ...
    def hasQueryItem(self, key: str) -> bool: ...
    def queryItems(self, options: QUrl.ComponentFormattingOption = ...) -> typing.List[typing.Tuple[str, str]]: ...
...
class QUuid(PyQt6.sip.simplewrapper):
    ...
    @staticmethod
    def fromRfc4122(a0: QByteArray) -> 'QUuid': ...
    ...
    @typing.overload
    @staticmethod
    def createUuidV5(ns: 'QUuid', baseData: QByteArray) -> 'QUuid': ...
    @typing.overload
    @staticmethod
    def createUuidV5(ns: 'QUuid', baseData: str) -> 'QUuid': ...
    @typing.overload
    @staticmethod
    def createUuidV3(ns: 'QUuid', baseData: QByteArray) -> 'QUuid': ...
    @typing.overload
    @staticmethod
...
class QXmlStreamWriter(PyQt6.sip.simplewrapper):
    ...
    def __init__(self, device: QIODevice) -> None: ...
    @typing.overload
    def __init__(self, array: QByteArray) -> None: ...
...
class QMutexLocker(PyQt6.sip.simplewrapper):
    ...
    @typing.overload
    def __init__(self, mutex: QRecursiveMutex) -> None: ...
...
class QWinEventNotifier(QObject):
    ...
    def event(self, e: QEvent) -> bool: ...
    def activated(self, hEvent: PyQt6.sip.voidptr) -> None: ...
...
def pyqtSlot(*types, name: typing.Optional[str] = ..., result: typing.Optional[str] = ...) -> typing.Any: ...
